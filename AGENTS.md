...
- Functionality that is generic and universal (e.g. parsing or encryption of messages) should go in `threema-gateway-rs`
- Functionality that is specific to certain use cases (e.g. session handling for LLM based bots) should go
  into a separate crate or directly into the bot codebase
